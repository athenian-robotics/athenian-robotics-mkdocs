...
## Learning
* [How to learn to code in Java: why you should and where to start](https://dev.to/selawsky/how-to-learn-to-code-in-java-why-you-should-and-where-to-start-38a3)
* [CodeGym](https://codegym.cc)
* [Java Courses](https://www.edx.org/learn/java)